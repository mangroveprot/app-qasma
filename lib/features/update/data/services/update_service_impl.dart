...
class UpdateServiceImpl implements UpdateService {
  ...
  Future<Either<AppError, Map<String, dynamic>>> getUpdateInfo() async {
    try {
      ...
      _logger.d(
          '📱 Package Info - Version: $currentVersion, Build: $currentBuild');
        ...
        (latestRelease) async {
          ...
          return hasUpdateResult.fold(
            ...
            (hasUpdate) {
              ...
              _logger.d('Returning map with keys: ${resultMap.keys.toList()}');
              _logger.d('currentVersion value: ${resultMap['currentVersion']}');
              _logger.d('currentBuild value: ${resultMap['currentBuild']}');
